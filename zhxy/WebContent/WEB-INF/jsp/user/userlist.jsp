           ...
           <div class="admin-content">
            <div class="admin-content-body">
            	...
            	<div class="am-cf am-padding am-padding-bottom-0">
        			<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">你现在所在的位置是:</strong> >> <small>查询用户列表</small>
        			</div>
      			</div>
      			<div class="am-u-sm-12 am-u-md-3">
            		...
            		<div class="am-u-sm-12">
              			...
              			<thead>
              			<tr>
               				<th class="table-id">用户编码</th>
               				<th class="table-name">用户姓名</th>
               				<th class="table-gender">用户密码</th>
               				
              			</tr>
            			</thead>
             	 <tbody>
              		<tr>
              		<c:forEach var="user" items="${queryUserList }" varStatus="status">
						<tr>
						<td>
